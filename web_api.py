...
def retrieve_data_weather(location):
    URL_1 = f"https://goweather.herokuapp.com/weather/{location}"
    ...
    data = Weather(temp, wind, location, description, is_day) #description Sunny, Partly cloudy, Clear, Rain, light rain, Cloudy
    return data
